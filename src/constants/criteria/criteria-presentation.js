...
const firstImpression = {
  ...
  examples: {
    excellent:
      'It was just amazing, the smell, the look, the whole dish was outstanding',
...
const plating = {
  ...
  examples: {
    excellent:
      'Every piece had its reason, the quality of the detail was amazing',
    ...
    belowAverage:
      'Ingredients mess up, some placements only serves for good looking but made it hard to eat',
    underperformed:
      'I had a hard time eating the dish, not willing to suffer that again',
  },
};
