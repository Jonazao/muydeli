...
const expectation = {
  ...
  examples: {
    excellent: 'The price was lower than average, the flavor outstanding, it is just amazing',
...
const flavor = {
  id: 'flavor',
  title: flavorLabel,
  description: 'The taste of the food, the umami, what makes you enjoy what you eat',
  examples: {
    ...
    expected: 'It matches the average, you can find similar dishes for similar prices in other places',
